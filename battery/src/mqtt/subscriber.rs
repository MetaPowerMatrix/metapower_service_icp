...
const DFLT_BROKER:&str = "tcp://api.metapowermatrix.ai:1883";
const DFLT_CLIENT:&str = "metapower_agent";
const DFLT_TOPICS:&[&str] = &["/metapower/translate/done", "/metapower/answer/done"];
