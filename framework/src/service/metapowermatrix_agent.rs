...
pub mod meta_power_matrix_agent_svc_server {
    ...
    #[async_trait]
    pub trait MetaPowerMatrixAgentSvc: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct MetaPowerMatrixAgentSvcServer<T> {
        inner: Arc<T>,
    ...
    impl<T> MetaPowerMatrixAgentSvcServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for MetaPowerMatrixAgentSvcServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "metapowermatrix_agent.MetaPowerMatrixAgentSvc";
    impl<T> tonic::server::NamedService for MetaPowerMatrixAgentSvcServer<T> {
