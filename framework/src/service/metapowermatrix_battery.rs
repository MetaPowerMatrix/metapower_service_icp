...
pub mod meta_power_matrix_battery_svc_server {
    ...
    #[async_trait]
    pub trait MetaPowerMatrixBatterySvc: std::marker::Send + std::marker::Sync + 'static {
        async fn talk(
            &self,
    ...
    #[derive(Debug)]
    pub struct MetaPowerMatrixBatterySvcServer<T> {
        inner: Arc<T>,
    ...
    impl<T> MetaPowerMatrixBatterySvcServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for MetaPowerMatrixBatterySvcServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "metapowermatrix_battery.MetaPowerMatrixBatterySvc";
    impl<T> tonic::server::NamedService for MetaPowerMatrixBatterySvcServer<T> {
