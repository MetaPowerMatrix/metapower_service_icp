...
pub mod meta_power_matrix_controller_svc_server {
    ...
    #[async_trait]
    pub trait MetaPowerMatrixControllerSvc: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct MetaPowerMatrixControllerSvcServer<T> {
        inner: Arc<T>,
    ...
    impl<T> MetaPowerMatrixControllerSvcServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for MetaPowerMatrixControllerSvcServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "metapowermatrix_controller.MetaPowerMatrixControllerSvc";
    impl<T> tonic::server::NamedService for MetaPowerMatrixControllerSvcServer<T> {
